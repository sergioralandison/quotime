<?php include('header.php'); ?> <?php /*Cette ligne fait appel au fichier page1.php*/?>
...
<div class="align-items-center d-flex flex-row vw-100 vh-100">
  ...
  <div class="w-50 h-100 bg-secondary box-right">
    ...
    <button class="btn text-white btn-bars fixed-top" type="button"><i class="fa fa-bars"></i></button>
    <button class="btn text-white btn-search fixed-top" type="button"><i class="fa fa-search"></i></button>-->

    <!--Partie en bas à droite avec les icônes à liens externes-->
    <p class="follow-text fixed-bottom">Follow us</p>
    <a href="https://dribbble.com/"><button class="btn btn-dribble text-white fixed-bottom" type="button"><i class="fa fa-dribbble"></i></button></a>
    <a href="https://www.instagram.com/"><button class="btn btn-ins text-white fixed-bottom" type="button"><i class="fa fa-instagram"></i></button></a>
    <a href="https://www.facebook.com/"><button class="btn btn-fb text-white fixed-bottom" type="button" ><i class="fa fa-facebook"></i></button></a>
...
<?php include('footer.php'); ?> <?php /*Cette ligne fait appel au fichier footer.php*/?>
